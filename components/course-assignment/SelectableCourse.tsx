...
function SelectableCourse({
  ...
  return (
    <Card
      ...
      className="flex flex-col h-full p-0 dark:bg-gray-900/90 overflow-hidden hover:shadow-lg dark:hover:shadow-lg transition-all duration-200 cursor-pointer border border-border shadow-md dark:shadow-md"
    >
